        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="space-y-2">
            ...
            <p className="text-slate-500">
              Explore our range of precision engineering tools and devices.
            </p>
          </div>
        ...
        <div className="bg-slate-950 rounded-3xl overflow-hidden shadow-2xl text-white">
          <div className="flex flex-col lg:flex-row h-full">
            <div className="lg:w-1/2 p-12 lg:p-20 flex flex-col justify-center space-y-8">
              <span className="text-blue-500 font-bold tracking-wider text-xs uppercase">
                Excellence
              </span>
              ...
              <p className="text-slate-400 text-lg leading-relaxed">
                Every component is selected from the finest manufacturers
                globally. Our strict quality control ensures that what you build
                is built to last.
              </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Military-grade signal isolation.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 text-center">
        <div className="bg-linear-to-b from-white to-slate-50 border border-slate-100 p-12 rounded-3xl shadow-sm">
          ...
          <p className="text-slate-500 max-w-xl mx-auto mb-8">
            ...
            build products that are tailored to your specific industrial needs.
          </p>
    ...
    <Link href={`/product/${slug}`} className="block h-full">
      <div className="bg-white rounded-2xl border border-slate-100 p-4 hover:shadow-xl hover:border-slate-200 transition-all duration-300 group cursor-pointer flex flex-col h-full">
        ...
        <div className="px-2 pb-2 flex-1 flex flex-col">
          <span className="text-blue-600 text-[10px] font-bold uppercase tracking-widest mb-2">
            {category}
          </span>
