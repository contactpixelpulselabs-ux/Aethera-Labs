        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-8">
            ...
            <p className="text-lg text-slate-500 max-w-md leading-relaxed">
              The 200W Class-D heart of your home audio system. Engineered for
              transparency and dynamic range.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          <div className="mb-12">
            ...
            <p className="text-slate-500 max-w-xl mx-auto">
              Software is great. Hardware is forever. We don&apos;t use
              off-the-shelf modules. Everything is custom.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            <div className="bg-slate-50 p-10 rounded-3xl hover:shadow-lg transition-shadow h-full">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Seamless low-latency wireless streaming combined with a pure
                analog signal path for your legacy gear.
              </p>
            </div>
              ...
              <div className="bg-slate-50 p-6 rounded-3xl hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      New feedback-based distortion monitoring.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-8 bg-slate-950 text-white px-10 py-7 rounded-3xl flex flex-col md:flex-row justify-between items-center">
            <div className="mb-3 md:mb-0">
              <h4 className="text-xs uppercase tracking-widest text-slate-500 mb-1.5">
                Industrial Design
              </h4>
            ...
            <div className="text-center md:text-right">
              <p className="text-sm text-slate-400">
                Extruded from solid blocks of aviation-grade alloy.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative h-[600px] w-full bg-slate-950 flex items-center justify-center text-center px-6">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-slate-300 text-lg leading-relaxed">
            Experience soundstages that extend well beyond the walls of your
            room. The Crystal X doesn&apos;t just amplify sound; it reveals the
            emotion hidden within the silence between the notes.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="space-y-4">
          {[
            ...
            <div
              key={i}
              className="flex justify-between items-center py-4 border-b border-slate-100 last:border-0 hover:bg-slate-50 px-4 rounded-lg transition-colors leading-loose"
            >
              <span className="text-xs font-bold uppercase tracking-widest text-slate-400 w-1/3">
                {spec.label}
              </span>
              <span className="font-bold text-slate-900 text-right w-2/3">
                {spec.value}
              </span>
            </div>
          ))}
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div className="flex-1">
              <h3 className="text-3xl font-bold text-slate-900 mb-4">
                The Aethera Standard.
              </h3>
              <p className="text-slate-600 text-base leading-relaxed max-w-lg">
                We stand behind our engineering. Each device is hand-tested in
                our labs for 48 hours before shipment. We only ship perfection.
              </p>
            </div>
